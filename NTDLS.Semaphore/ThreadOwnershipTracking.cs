namespace NTDLS.Semaphore
{
    ...
    public static class ThreadOwnershipTracking
    {
        ...
        /// <summary>
        /// Enables tracking of the current thread that owns the lock and a maintains a dictonary of all threads
        /// that own locks. This can be handy when identifying deadlocks and race conditions. Once enabled, the
        /// tracking is attributed to all critical sections for the life of the applicaiton.
